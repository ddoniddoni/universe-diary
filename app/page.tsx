...
export default async function Home() {
  ...
  return (
    <main className="relative flex min-h-svh flex-1 items-center justify-center overflow-hidden bg-[radial-gradient(ellipse_at_50%_18%,#31205d_0%,#101331_40%,#03040d_78%)] px-6 text-center">
      ...
      {user && (
        <div className="absolute right-4 top-4 z-10 flex items-center gap-1 rounded-2xl border border-white/10 bg-[#080b20]/55 p-1.5 text-sm shadow-xl backdrop-blur-xl sm:right-7 sm:top-7">
          <span className="hidden px-2 text-[#c9cada] sm:inline">{user.nickname}님의 우주</span>
          <LogoutButton />
        </div>
      )}
