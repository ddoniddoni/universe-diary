...
import { EMOTION_STAR_COLORS, type EmotionKey } from "@/lib/star";

type SceneStar = { id: string; diaryId: string; title: string; diaryDate: string; color: string; emotion: string; x: number; y: number };
